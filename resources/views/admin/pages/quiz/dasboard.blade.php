                    ...
                    <div class="dashboard-container">
                        <form action="{{ route('quiz.create') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <select width="100%" class=" form-control" style="outline: 0"
                                            name="quiz_type" id="select1">
                                        <option value="">Select Quiz Type</option>
                                        <option value="First"
                                        @if (old('quiz_type') == 'First') {{ 'selected' }} @endif>First
                                        </option>

                                        <option value="Next"
                                        @if (old('quiz_type') == 'Next') {{ 'selected' }} @endif>Next
                                        </option>

                                    </select>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary  btn-sm btn-success mt-2">Create</button>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="dashboard-container">
                        ...
                        @foreach($record as $key =>$rec)
                            ...
                            <div class="row">
                                ...
                                <form method="POST"
                                      action="{{ route('prize.prizeupdate', ['prize' => $record[$key]->id]) }}">
                                    {{ csrf_field() }}
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-2" style=" display: flex;">
                                        ...
                                        <button class="btn btn-warning btn-sm" style="margin-right:5px;" role="button"
                                                type="submit"> Update quiz
                                        </button>
                                ...
                                <div class="col-md-2">
                                    <form method="POST"
                                          action="{{ route('prize.delete', ['prize' => $record[$key]->id]) }}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                        <button class="btn  btn-sm btn-danger text-danger" title="Delete Prize"
                                                type="submit">Delete Prize
                                        </button>
                                    </form>
                                </div>
                            </div>
